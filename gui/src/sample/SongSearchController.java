...
public class SongSearchController implements Initializable {
    ...
    public Song createSong(Integer songID, String username) {
        ...
        button.setOnAction((ActionEvent e) -> {
            ...
            // INSERT INTO "PLContains" VALUES(23, 'sleep playlist', 'lkeepence2f');
            String addSongQuery = "INSERT INTO \"PLContains\" VALUES(" + songID + ", '"
    ...
    public void runQuery(String query) {
        try {
            //get set of songs already in playlist
            Set<Integer> plSongIDs = new HashSet<>();
